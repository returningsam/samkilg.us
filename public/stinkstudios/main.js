...
function tokenize_content() {
  ...
  for (var i = 0; i < objs.length; i++) {
    ...
    for (var j = 0; j < tokens.length; j++) {
      if (tokens[j] == "work" && tokens[j+1] == "here.") {
        objs[i].innerHTML += "<a href='https://randart.xyz'><span>" + tokens[j] + " " + tokens[j+1].replace(".","") + "</span></a><span>. </span> ";
        j++;
      }
      else {
  ...
  for (var i = 0; i < objs.length; i++) {
    ...
    for (var j = 0; j < tokens.length; j++) {
      if (tokens[j] == "Sam") {
        objs[i].innerHTML += "<a href='https://samkilg.us'><span>" + tokens[j] + " " + tokens[j+1] + "</span></a>";
        j++;
      }
      else {
        objs[i].innerHTML += "<div><span>" + tokens[j] + " </span></div>";
      }
    }
  }
  setTimeout(function () {
